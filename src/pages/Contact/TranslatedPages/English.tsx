    ...
    <div className="flex h-full flex-col">
      ...
      <div className="m-auto flex max-w-[80%] flex-1 flex-col gap-4 sm:max-w-[90%] md:max-w-[90%]">
        ...
        >
          ...
          <span className="text-center font-bold">Hit me up on WhatsApp!</span>
        </a>
      </div>
    </div>
  )
